...
print s (you are right that using public infrastructure for our tools is rude at best, plus there are issues of how we would let ipython.org see our notebooks across the web without making them available to the general public)
