...
print  flight_distances[frozenset(['Chicago', 'Seattle'])]
...
print flight_distances[frozenset(['Austin', 'Houston'])] + flight_distances[frozenset(['Houston', 'San Francisco'])]
...
flight_distances[frozenset(['Austin', 'San Francisco'])] = 1500.0
...
merger =set(flying_circus_cities)  | set(southby_cities)

diff =set(southby_cities) - set(flying_circus_cities)
...
def total_distance(city_list):
    total_distance = 0
    #if frozenset([city_list[0], city_list[-1]]) in flight_distances:
            #print flight_distances[frozenset([city_list[0], city_list[-1]])]
            #total_distance += flight_distances[frozenset([city_list[0], city_list[-1]])]
    for i in range(len(city_list) - 1):
        if frozenset([city_list[i], city_list[i+1]]) in flight_distances:
            #print flight_distances[frozenset([city_list[i], city_list[i+1]])]
            total_distance += flight_distances[frozenset([city_list[i], city_list[i+1]])]
